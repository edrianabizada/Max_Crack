...
logo = '\nAuther   : Dark\nTelegram : @edrisnabizada420\nChannel  : Edris Cracker\nCreate   : @edrisnabizada420 @edrisnabizada420\nNote     : Nrxi am toola 10$\nCracked Edris Nabizada\n--------------------------------------------------\n                                '
back = 0
successful = []
cpb = []
oks = []
id = []
os.system('clear')
os.system('figlet Edris Nabizada')
print '===================\nLoading... |'
time.sleep(0.1)
os.system('clear')
os.system('figlet Edris Nabizada')
...
time.sleep(0.1)
os.system('clear')
os.system('figlet Edris')
print '===================\nLoading... /'
time.sleep(0.1)
os.system('clear')
os.system('Edris Nabizada')
print '===================\nLoading... -'
time.sleep(0.1)
os.system('clear')
os.system('Edris Nabizada')
...
if __name__ == '__main__':
    print 'Cracked ID Active'
    print 'Binyamin_binni'
    print 'Fucked'
    time.sleep(3)
    menu()